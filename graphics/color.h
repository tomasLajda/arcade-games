...
#ifndef ARCADE_GAMES_COLOR_H
#define ARCADE_GAMES_COLOR_H
...
public:
    ...
    static Color LightGrey() {return Color(128,128,128,255);}
    static Color DarkGrey() {return Color(180,180,180,255);}
