...
void Excluder::SetupEdges() {
    auto rectPoints = mAARect.GetPoints();

    mEdges[TOP_EDGE].edge = {rectPoints[0], rectPoints[1]};
    mEdges[TOP_EDGE].normal = UP_DIR;

    mEdges[LEFT_EDGE].edge = {rectPoints[0], rectPoints[3]};
    mEdges[LEFT_EDGE].normal = LEFT_DIR;

    mEdges[BOTTOM_EDGE].edge = {rectPoints[2], rectPoints[3]};
    mEdges[BOTTOM_EDGE].normal = DOWN_DIR;

    mEdges[RIGHT_EDGE].edge = {rectPoints[1], rectPoints[2]};
